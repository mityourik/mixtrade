  ...
  return (
    <section className={styles.equip}>
      <div className={styles['equip__grid']}>
        ...
        <button className={styles['equip__button']}><span className={styles['equip__button_back']}/></button>
        <img className={styles['equip__image']} src={mixer} alt="equip"/>
        <button className={styles['equip__button']}><span className={styles['equip__button_forward']}/></button>
