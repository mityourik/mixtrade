    ...
    <section className={styles.feedback}>
      <div className={styles.feedback__container}>
        ...
        <div className={styles.feedback__info}>
          ...
          <div className={styles.feedback__icons}>
            <div
              className={`${styles.feedback__icon} ${styles['feedback__icon--telegram']}`}
            ></div>
            <div
              className={`${styles.feedback__icon} ${styles['feedback__icon--whatsapp']}`}
            ></div>
            <div
              className={`${styles.feedback__icon} ${styles['feedback__icon--phone']}`}
            ></div>
          </div>
        </div>
      </div>
